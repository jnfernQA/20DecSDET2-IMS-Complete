 ...
 * 
 * import com.qa.ims.persistence.domain.Customer; import
 * com.qa.ims.utils.DatabaseUtilities;
 * 
 ...
 * 
 * @Test public void testReadAll() { List<Customer> expected = new
 * ArrayList<>(); expected.add(new Customer(1L, "jordan", "harrison"));
 * assertEquals(expected, DAO.readAll()); }
 * 
 * @Test public void testReadLatest() { assertEquals(new Customer(1L, "jordan",
 * "harrison"), DAO.readLatest()); }
 * 
 * @Test public void testRead() { final long ID = 1L; assertEquals(new
